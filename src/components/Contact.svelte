...
<section id="contactus" class="mt-20">
  <div class="flex w-full flex-col justify-center">
    ...
    >
      Contact us now to try out our free demo.
    </span>
  </div>
  <div class="container mx-auto px-6 py-10">
    <div class="lg:-mx-6 lg:flex lg:items-center">
      <div class="lg:mx-0 lg:mt-0 lg:flex lg:w-1/2 lg:flex-col lg:items-center">
        <div class="mt-6 space-y-8 md:mt-8">
          <p class="-mx-2 flex items-start">
            <svg
              ...
              class="text-base-400 mx-2 h-6 w-6"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-Width="2"
        ...
        <div class="mt-6 w-80 md:mt-8">
          ...
          <div class="-mx-1.5 mt-4 flex">
            <a
              class="btn mx-1.5 rounded-full bg-[#86736B]/35"
      ...
      <div class="card mt-8 lg:mx-6 lg:w-1/2">
        <div
          class="card-body mx-auto w-full overflow-hidden rounded-lg px-8 py-10 shadow-xl outline outline-base-content/5 lg:max-w-xl"
        >
          <h1 class="card-title">Want to try our Demo</h1>

          <form class="mt-6">
            <div class="flex-1">
              <label for="full-name" class="mb-2 block text-sm"> Full Name </label>
              <input
                id="name"
                autoComplete="name"
                type="text"
            ...
            <div class="mt-6 w-full">
              <label for="message" class="mb-2 block text-sm"> Message </label>
              <textarea
                id="message"
            ...
            <button
              class="btn btn-neutral bg-[#C7D5D8] text-[#231A01] hover:bg-[#86736B]/35 mt-6 w-full transform px-6 py-3 text-sm font-medium capitalize duration-300"
            >
              Get Fitted
            </button>
          </form>
  ...
  >
    <h1>© 2024 Fitted. All rights reserved.</h1>
  </div>
</section>
